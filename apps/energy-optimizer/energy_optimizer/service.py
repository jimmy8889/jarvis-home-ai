    ...
    async def _publish_plan_unlocked(
        ...
        *,
        ...
        publishes = [
            ...
            self.ha.publish_state("sensor.energy_optimizer_solar_potential", round(plan.solar_potential_kw, 3), {
                **common,
            ...
            self.ha.publish_state("sensor.energy_optimizer_solar_actual", round(plan.solar_actual_kw, 3), {
                **common,
            ...
            self.ha.publish_state("sensor.energy_optimizer_solar_curtailed", round(plan.solar_curtailed_estimate_kw, 3), {
                **common,
